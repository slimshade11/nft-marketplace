...
export const isAddressLoading = createSelector(Web3StateSelector, ({ isAddressLoading }: Web3State): boolean => isAddressLoading);
...
export const isNetworkLoading = createSelector(Web3StateSelector, ({ isNetworkLoading }: Web3State): boolean => isNetworkLoading);
